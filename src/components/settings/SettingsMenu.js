    ...
    _createPreviewElement(previewConfig) {
        ...
        const previewCreators = {
            ...
            'pieces': (config) => {
                ...
                preview.innerHTML = `
                    <img src="assets/pieces/${config.folder}/wK.svg" alt="White King" class="piece-preview-icon">
                    <img src="assets/pieces/${config.folder}/bQ.svg" alt="Black Queen" class="piece-preview-icon">
                `;
                return preview;
            }
        };
