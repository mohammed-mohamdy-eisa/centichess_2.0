...
export const Classification = {
    ...
    THEORY: {
        ...
        accuracy: 0.975,  // Calibrated: same as BEST (theory moves in Chess.com)
        comment: "is theory.",
        color: "#d5a47d" // var(--color-classification-theory) → var(--color-skin-300). Theory and theory share color in chess.com/lichess
    },
    INACCURACY: {
        type: "inaccuracy",
...
export class MoveClassifier {
    ...
    static classifyMove(move, previous, moves) {
        ...
        // If the move has no score, it's probably because the opening theory didn't work
        if (move.score === null) {
